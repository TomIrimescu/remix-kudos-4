...
export function SearchBar({ profile }: props) {
  ...
  return (
    <form className='w-full px-6 flex flex-wrap items-center gap-x-4 border-b-4 border-b-blue-900 border-opacity-30 mt-[9px]'>
      ...
      <UserCircle
        className='h-14 w-14 transition duration-300 ease-in-out hover:scale-110 hover:border-2 hover:border-yellow-300 mb-[12px] mt-[9px]'
        profile={profile}
